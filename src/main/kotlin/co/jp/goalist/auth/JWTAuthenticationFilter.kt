...
class JwtAuthenticationFilter(
    ...
    override fun attemptAuthentication(req: HttpServletRequest, response: HttpServletResponse): Authentication {
        val credentials = ObjectMapper().readValue(req.inputStream, UserAuth::class.java)
    ...
    override fun successfulAuthentication(
        ...
        val user = auth.principal as UserSecurity
        val token: String = jwtTokenUtil.generateToken(user.username, user.password)
